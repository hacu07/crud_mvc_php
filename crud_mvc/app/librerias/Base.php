<?php 
	...
	class Base
	{
		...
		private $stmt; //Statement para ejecutar consulta
		private $error;
		...
		function __construct()
		{
			...
			try {
				...
				$this->dbh->exec('set names utf8');//arregla los caracteres especiales que trae de la bd
			} catch (Exception $e) {
